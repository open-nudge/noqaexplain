...
# Security self-assessment of noqaexplain
...
| Creator           | open-nudge                                                                                               |
| Software          | [https://github.com/open-nudge/noqaexplain](https://github.com/open-nudge/noqaexplain)                   |
| Website           | [https://open-nudge.github.io/noqaexplain](https://open-nudge.github.io/noqaexplain)                     |
| Security Provider | No                                                                                                       |
| Languages         | Python                                                                                                   |
| SBOM              | [https://github.com/open-nudge/noqaexplain/releases](https://github.com/open-nudge/noqaexplain/releases) |

### Security links

| Category          | Resource                                                                                                                                               |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Security File     | [https://github.com/open-nudge/noqaexplain/blob/main/SECURITY.md](https://github.com/open-nudge/noqaexplain/blob/main/SECURITY.md)                     |
| Security Insights | [https://github.com/open-nudge/noqaexplain/blob/main/SECURITY-INSIGHTS.yml](https://github.com/open-nudge/noqaexplain/blob/main/SECURITY-INSIGHTS.yml) |
| Dependencies      | [https://github.com/open-nudge/noqaexplain/blob/main/pyproject.toml](https://github.com/open-nudge/noqaexplain/blob/main/pyproject.toml)               |
| Release Artifacts | [https://github.com/open-nudge/noqaexplain/releases](https://github.com/open-nudge/noqaexplain/releases)                                               |
...
| --------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| template  | Critical      | Base GitHub template of the repository provided by `opennudge`. Used to provide initial security posture (pipelines, pre-commit, practices, hardening etc.) See [open-nudge/noqaexplain](https://github.com/open-nudge/noqaexplain) for more information |
...
The [`open-nudge/noqaexplain`](https://github.com/open-nudge/noqaexplain)
security policy is maintained in the
[`SECURITY.md`](https://github.com/open-nudge/noqaexplain/blob/master/SECURITY.md)
file.
...
[`SECURITY.md`](https://github.com/open-nudge/noqaexplain/blob/master/SECURITY.md#reporting-a-vulnerability.)
file.
