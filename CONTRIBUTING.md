...
1. Verify [open issues](https://github.com/open-nudge/noqaexplain/issues)
...
1. If the issue does not exist, create a new one from the
    [Issues Templates](https://github.com/open-nudge/noqaexplain/issues/new/choose)
    tab.
...
- [`src/`](https://github.com/open-nudge/noqaexplain/blob/main/src/README.md)
    with the source code of the project
- [`tests/`](https://github.com/open-nudge/noqaexplain/blob/main/tests/README.md)
    with the project's tests

Check [project documentation](https://open-nudge.github.io/noqaexplain)
