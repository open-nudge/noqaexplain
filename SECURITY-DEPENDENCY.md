...
This policy describes how `noqaexplain` maintainers
consume third-party packages.

## Scope

This policy applies to all `noqaexplain` maintainers
and all third-party packages used in the `noqaexplain`
project.

## Policy

`noqaexplain` contributors must follow these guidelines
...
When adding a new third-party package to `noqaexplain`,
