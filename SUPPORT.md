...
- To learn more about using this project, see the
    [__documentation__](https://open-nudge.github.io/noqaexplain).
- To discuss the project, you can join the
    [__discussions__](https://github.com/open-nudge/noqaexplain/discussions).
    and follow the provided template.
- To report a bug or request a feature, you can
    [__open an issue__](https://github.com/open-nudge/noqaexplain/issues)
    and follow the provided template.
