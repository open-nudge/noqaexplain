...
- [Security Insights Specification](https://github.com/open-nudge/noqaexplain/blob/main/SECURITY-INSIGHTS.yml)
...
- [Renovate Bot](https://github.com/open-nudge/noqaexplain/blob/main/.github/renovate.json)
    for automated dependency updates
- [Software Bills Of Material (SBOMs)](https://github.com/open-nudge/noqaexplain/releases)
- [Sigstore signing](https://github.com/open-nudge/noqaexplain/releases)
